...
import {
  ConfirmarVerificacionCorreoRequestDto,
  VerificacionCorreoResponseDto,
} from '../modelos/verificacion-correo.dto';
...
export class VerificacionCorreoApiService {
  ...
  confirmar(token: string): Observable<ResultadoVerificacionCorreo> {
    const request: ConfirmarVerificacionCorreoRequestDto = { token };
