...
export const ADMINISTRACION_ROUTES: Routes = [
  {
    path: '',
    providers: [AdministracionPanelStore],
    children: [
      {
        path: '',
        pathMatch: 'full',
      ...
      {
        path: 'documentos',
        title: 'Revisión documental | REGALIA',
        loadComponent: () =>
          import('./paginas/pagina-admin-documentos/pagina-admin-documentos').then(
            (m) => m.PaginaAdminDocumentos,
          ),
      },
      {
