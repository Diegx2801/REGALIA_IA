  ...
  private readonly products: CatalogProduct[] = [
    {
      ...
      reviews: 128,
      discountLabel: '-15%',
      shippingLabel: 'Envio gratis',
      warrantyLabel: '36 meses',
      sellerBadge: 'Top venta',
    },
    {
      id: 2,
      category: 'CPU',
      ...
      reviews: 94,
      discountLabel: '-12%',
      shippingLabel: 'Retiro hoy',
      warrantyLabel: '36 meses',
      sellerBadge: 'Recomendado',
    },
    {
      id: 3,
      category: 'GPU',
      ...
      discountLabel: '-15%',
      shippingLabel: 'Envio gratis',
      warrantyLabel: '24 meses',
      sellerBadge: 'Oferta gamer',
    },
    {
      id: 4,
      category: 'GPU',
    ...
    },
    {
      ...
      reviews: 68,
      discountLabel: '-14%',
      shippingLabel: 'Llega manana',
      warrantyLabel: '24 meses',
      sellerBadge: 'Compatible AM5',
    },
    {
      id: 6,
      category: 'Motherboard',
    ...
    },
    {
      ...
      discountLabel: '-14%',
      shippingLabel: 'Envio gratis',
      warrantyLabel: 'Lifetime',
      sellerBadge: 'Mas vendido',
    },
    {
      id: 8,
      category: 'RAM',
    ...
    },
    {
      ...
      discountLabel: '-18%',
      shippingLabel: 'Envio gratis',
      warrantyLabel: '60 meses',
      sellerBadge: 'Oferta flash',
    },
    {
      id: 10,
      category: 'PSU',
    ...
    },
    {
      ...
      discountLabel: '-21%',
      shippingLabel: 'Llega manana',
      warrantyLabel: '12 meses',
      sellerBadge: 'Buen airflow',
    },
    {
      id: 12,
      category: 'Cooling',
