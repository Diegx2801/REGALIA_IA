...
/**
 * Campos permitidos para ordenar consultas administrativas de pedidos.
 */
public enum PedidoAdminSortField {
    ID_PEDIDO("idPedido"),
    ...
    private static final PedidoAdminSortField DEFAULT_FIELD = FECHA_CREACION;
    private static final Sort.Direction DEFAULT_DIRECTION = Sort.Direction.DESC;

    private final String apiName;

    PedidoAdminSortField(String apiName) {
        this.apiName = apiName;
    }

    public static PedidoAdminSortField desde(String sort) {
