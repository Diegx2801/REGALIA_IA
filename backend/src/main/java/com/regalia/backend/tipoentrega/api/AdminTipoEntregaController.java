...
/**
 * Controlador REST administrativo para gestionar tipos de entrega.
 */
@RestController
...
public class AdminTipoEntregaController {
    ...
    public ResponseEntity<ApiResponse<List<TipoEntregaResponse>>> listarTiposEntregaAdministracion() {
        List<TipoEntregaResponse> tiposEntrega = tipoEntregaService.listarTiposEntregaAdministracion();
    ...
    public ResponseEntity<ApiResponse<TipoEntregaResponse>> obtenerTipoEntregaAdministracionPorId(
            @PathVariable Long idTipoEntrega
    ) {
        TipoEntregaResponse tipoEntrega = tipoEntregaService.obtenerTipoEntregaAdministracionPorId(idTipoEntrega);
