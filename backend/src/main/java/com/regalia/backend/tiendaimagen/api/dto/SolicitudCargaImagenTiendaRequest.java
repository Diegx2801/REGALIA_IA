...
/** Datos declarados para solicitar una carga directa de identidad visual. */
public record SolicitudCargaImagenTiendaRequest(
        @NotBlank(message = "El tipo de imagen es obligatorio")
        @Size(max = 20, message = "El tipo de imagen no puede superar los 20 caracteres")
        String tipoImagen,
